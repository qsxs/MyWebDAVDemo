...
import com.lihb.mywebdavdemo.network.IResponse;
...
public abstract class WxObserver<T extends IResponse> implements Observer<T> {
...
//    private CommonDialogUtils dialogUtils;
    ...
    public WxObserver(Context context) {
        this(context, true, null);
    }

    public WxObserver(Context context, boolean isShowLoading) {
        this(context, isShowLoading, "加载中");
    }

    public WxObserver(Context context, boolean isShowLoading, String loadingMsg) {
