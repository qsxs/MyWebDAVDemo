 ...
 */
package com.lihb.mywebdavdemo.network.webdav.property;
 ...
 *
 *  org.apache.jackrabbit.webdav.DavConstants#XML_HREF
...
//    private static Logger log = LoggerFactory.getLogger(HrefProperty.class);
     ...
     * It will not be returned in a { org.apache.jackrabbit.webdav.DavConstants#PROPFIND_ALL_PROP DAV:allprop}
     * PROPFIND request.
     */
...
//                    log.warn("Valid DAV:href element expected instead of " + val.toString());
     ...
     *  org.apache.jackrabbit.webdav.xml.DomUtil#hrefToXml(String,org.w3c.dom.Document)
     * @param document
     */
    @Override
