...
import com.lihb.mywebdavdemo.network.webdav.lock.LockManager;
import com.lihb.mywebdavdemo.network.webdav.lock.Scope;
import com.lihb.mywebdavdemo.network.webdav.lock.Type;
...
import com.lihb.mywebdavdemo.network.webdav.property.PropEntry;
...
public interface DavResource {
    ...
    /**
     * Returns the { DavResourceLocator locator} object for this webdav resource,
...
//    public void spool(OutputContext outputContext) throws IOException;
    ...
    /**
     * Returns an array of all { DavPropertyName property names} available
     * on this resource.
     *
     ...
     * @return the { DavProperty} with the given name or <code>null</code>
     ...
     * return upon a { DavConstants#PROPFIND_ALL_PROP} request. The
     ...
     * { property.DavProperty#isInvisibleInAllprop()}.
     *
     * @return a { DavPropertySet} containing at least all properties
     ...
     *
     * @param changeList list containing { DavPropertyName} objects (for
     ...
     *
     * @param resource { DavResource} to be added as internal member.
...
//    public void addMember(DavResource resource, InputContext inputContext) throws DavException;
     ...
     *
     * @return a { DavResourceIterator} over all internal members.
     */
    ...
    /**
     * Add an external { LockManager} to this resource. This method may
